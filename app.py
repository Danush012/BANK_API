...
# Endpoint to the starting route
@app.route('/')
def home():
    return "Hello, everyone!, Welcome to the Bank API"

# Endpoint to get all the banks
@app.route('/banks', methods=['GET'])
def get_banks():
    return jsonify({"banks": banks})

# Endpoint to get branches of a specific bank
...
# Error handler for non-existing banks or branch IDs
